...
<template>
  <router-link
    ...
    class="box-border flex h-10 items-center gap-2 rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700 hover:shadow-sm [&.active]:bg-gray-100 [&.active]:text-gray-700 [&.active]:shadow-sm"
